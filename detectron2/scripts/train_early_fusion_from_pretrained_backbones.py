...
if __name__ == "__main__":
    ...
    cfg.MODEL.WEIGHTS = "/app/detectronDocker/early_fusion_pretrained_RGB_only.pkl"
    num_gpu = 1
    bs = (num_gpu * 2)    
    output_dir = "/app/detectronDocker/outputs/early_fusion_DRCNN-FPN-attention-relu_full_training_from_RGB_backbone_only"
    ...
    cfg.MODEL.FREEZE_INCLUDE = ["resnet1"]
