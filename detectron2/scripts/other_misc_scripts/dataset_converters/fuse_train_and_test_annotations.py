...
fuse_coco_annotations(
    os.path.join(dataset_path, "annotations_train.json"),
    os.path.join(dataset_path, "annotations_test.json"),
    os.path.join(dataset_path, "annotations_all.json"),
)
