...
if __name__ == "__main__":
    ...
    bs = num_gpu * 2
    cfg.MODEL.WEIGHTS = ""
    output_dir = "/app/detectronDocker/outputs/RCNN_RGB_New_datasets_no_OCID2"
    ...
    cfg.MODEL.PIXEL_MEAN = [103.827, 113.927, 119.949]
    cfg.MODEL.PIXEL_STD = [73.64243704, 69.95468926, 71.09685732]
