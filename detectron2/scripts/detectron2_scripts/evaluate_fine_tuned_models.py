...
models = [
    "/app/detectronDocker/outputs/early_fusion_new_datasets_normalized_input_no_OCID_FUSE_IN_COLOR"
]
...
with open(
    os.path.join("/app/detectronDocker/outputs", f"results_on_rocket_wheel_not_finetuned.json"), "w"
) as out_file:
