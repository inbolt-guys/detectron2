...
register_dataset("OCID_test", ocid_test_folder, annotations_file=ocid_test_annos)
ocid_train_annos = os.path.join(ocid_folder, "annotations_train.json")
ocid_train_folder = os.path.join(ocid_folder, "train")
register_dataset("OCID_train", ocid_train_folder, annotations_file=ocid_train_annos)
ocid_all_annos = os.path.join(ocid_folder, "annotations_all.json")
ocid_all_folder = os.path.join(ocid_folder, "all")
