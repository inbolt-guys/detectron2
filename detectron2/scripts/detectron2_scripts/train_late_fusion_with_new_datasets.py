...
if __name__ == "__main__":
    ...
    #cfg.MODEL.WEIGHTS = "/app/detectronDocker/late_pretrained_backbones_normalized_RGBRD.pth"
    num_gpu = 1
    bs = (num_gpu * 2)    
    output_dir = "/app/detectronDocker/outputs/late_fusion_new_datasets_normalized_input_fuse_in_DEPTH_no_OCID_ADD"
