...
if __name__ == "__main__":
    ...
    cfg.merge_from_file("/app/detectronDocker/outputs/early_fusion_DRCNN-FPN-attention-relu_full_training_test1/config.yaml")
    ...
    cfg.DATASETS.TRAIN = ("rocket_steel_1_instance_pose1","rocket_steel_1_instance_pose2") #optimal is 2000 iters with normal loss weights
