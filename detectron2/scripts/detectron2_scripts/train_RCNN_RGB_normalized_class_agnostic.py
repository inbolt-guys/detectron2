...
if __name__ == "__main__":
    ...
    pipeline.register_dataset(
        ...
        coco_train_folder,
        annotations_file="/app/detectronDocker/dataset_for_detectron/coco2017_depth/class_agnostic_annotations/instances_train2017.json",
    )
    pipeline.register_dataset(
        "coco_2017_depth_val",
        coco_val_folder,
        annotations_file="/app/detectronDocker/dataset_for_detectron/coco2017_depth/class_agnostic_annotations/instances_val2017.json",
    )
