...
if __name__ == "__main__":
    ...
    cfg.merge_from_file(
        "/app/detectronDocker/detectron2/configs/double_backbones_configs/Base-double_resnetDRCNN-FPN.yaml"
    )
    ...
    pipeline.register_dataset("TOD_test", tod_images, annotations_file=tod_annotations)
